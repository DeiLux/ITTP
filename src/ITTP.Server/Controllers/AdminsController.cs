...
namespace ITTP.Server.Controllers
{
    ...
    public class AdminsController : ControllerBase
    {
        ...
        public AdminsController(IUserService userService, ILogger<AdminsController> logger)
        {
        ...
        public async Task<IActionResult> ChangeAdmin([FromQuery] ChangeUserRequest changeUserRequest)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                _logger.LogError(ex, "Error in controller {controllerName} in method {methodName}.",
                     nameof(AdminsController), nameof(ChangeAdmin));
        ...
        [SwaggerResponse(statusCode: 401, type: typeof(EmptyResult), description: "Пользователь не авторизован")]
        [SwaggerResponse(statusCode: 500, type: typeof(EmptyResult), description: "Ошибка на стороне сервера")]
        public async Task<IActionResult> ChangeAdminPassword([FromQuery,
            ...
            Required] string password)
        {
            ...
            {
                _logger.LogError(ex, "Error in controller {controllerName} in method {methodName}.",
                     nameof(AdminsController), nameof(ChangeAdminPassword));
                return StatusCode(500);
            }
        }
        ...
        /// <response code="500">Ошибка на стороне сервера</response>
        [Authorize(true)]
        [HttpPost("change-admin-login")]
        [SwaggerOperation("Изменение логина")]
        [SwaggerResponse(statusCode: 200, type: typeof(EmptyResult), description: "Пользователь изменен")]
        [SwaggerResponse(statusCode: 400, type: typeof(EmptyResult), description: "Пользователь не изменен")]
        [SwaggerResponse(statusCode: 401, type: typeof(EmptyResult), description: "Пользователь не авторизован")]
        [SwaggerResponse(statusCode: 500, type: typeof(EmptyResult), description: "Ошибка на стороне сервера")]
        public async Task<IActionResult> ChangeAdminLogin([FromQuery,
            RegularExpression(@"[0-9A-Za-z]+",
            ErrorMessage = "Запрещены все символы кроме латинских букв и цифр"),
            Required] string login)
        {
            ...
            {
                _logger.LogError(ex, "Error in controller {controllerName} in method {methodName}.",
                     nameof(AdminsController), nameof(ChangeAdminLogin));
                return StatusCode(500);
            }
        }
        ...
        [SwaggerResponse(statusCode: 401, type: typeof(EmptyResult), description: "Пользователь не авторизован")]
        [SwaggerResponse(statusCode: 500, type: typeof(EmptyResult), description: "Ошибка на стороне сервера")]
        public async Task<IActionResult> ReadAdminAsync()
        {
            try
            {
                var user = (User)HttpContext.Items[nameof(AuthData)]!;
            ...
            {
                _logger.LogError(ex, "Error in controller {controllerName} in method {methodName}.",
                     nameof(AdminsController), nameof(ReadAdminAsync));
                return StatusCode(500);
            }
        }
        ...
        public async Task<IActionResult> CreateUser([FromQuery] CreateUserRequest createUserRequest)
        {
            ...
            {
                _logger.LogError(ex, "Error in controller {controllerName} in method {methodName}.",
                     nameof(AdminsController), nameof(CreateUser));
                return StatusCode(500);
            }
        }
        ...
        public async Task<IActionResult> ChangeUserAdmin([FromQuery] ChangeUserAdminRequest changeUserAdminRequest)
        {
            ...
            {
                _logger.LogError(ex, "Error in controller {controllerName} in method {methodName}.",
                     nameof(AdminsController), nameof(ChangeUserAdmin));
                return StatusCode(500);
            }
        }
            ...
            Required] string password)
        {
            ...
            {
                _logger.LogError(ex, "Error in controller {controllerName} in method {methodName}.",
                     nameof(AdminsController), nameof(ChangeUserAdminPassword));
                return StatusCode(500);
            }
        }
            ...
            Required] string loginNew)
        {
            ...
            {
                _logger.LogError(ex, "Error in controller {controllerName} in method {methodName}.",
                     nameof(AdminsController), nameof(ChangeUserAdminLogin));
                return StatusCode(500);
            }
        }
        ...
        public async Task<IActionResult> ReadUsersRevokedOnNullAsync()
        {
            ...
            {
                _logger.LogError(ex, "Error in controller {controllerName} in method {methodName}.",
                     nameof(AdminsController), nameof(ReadUsersRevokedOnNullAsync));
                return StatusCode(500);
            }
        }
            ...
            Required] string login)
        {
            ...
            {
                _logger.LogError(ex, "Error in controller {controllerName} in method {methodName}.",
                     nameof(AdminsController), nameof(ReadUserLoginAsync));
                return StatusCode(500);
            }
        }
        ...
        public async Task<IActionResult> ReadUsersAsync([FromQuery, Required] int age)
        {
            ...
            {
                _logger.LogError(ex, "Error in controller {controllerName} in method {methodName}.",
                     nameof(AdminsController), nameof(ReadUsersAsync));
                return StatusCode(500);
            }
        }
            ...
            Required] string login)
        {
            ...
            {
                _logger.LogError(ex, "Error in controller {controllerName} in method {methodName}.",
                     nameof(AdminsController), nameof(DeleteUserFullAsync));
                return StatusCode(500);
            }
        }
            ...
            Required] string login)
        {
            ...
            {
                _logger.LogError(ex, "Error in controller {controllerName} in method {methodName}.",
                     nameof(AdminsController), nameof(DeleteUserSoftAsync));
                return StatusCode(500);
            }
        }
            ...
            Required] string login)
        {
            ...
            {
                _logger.LogError(ex, "Error in controller {controllerName} in method {methodName}.",
                     nameof(AdminsController), nameof(RecoveryUserAsync));
                return StatusCode(500);
            }
        }
    }
